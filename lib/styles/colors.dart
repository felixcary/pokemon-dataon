...
class AppColors {
  ...
  static const Color electric = Color(0xFFF4D23C);
  ...
  static const Color steel = Color(0xFF5A5465);
  static const Color ground = Color(0xFFC5B78C);
  ...
  static const Color darkBlue = Color(0xFF173EA5);
}
